...
#ifndef __TEENSY_BME280_H__ 
#define __TEENSY_BME280_H__

#include "Arduino.h"
#include <Adafruit_Sensor.h> //used to complete the proper conversions for sensor values
#include <SPI.h> //this is not designed to work with I2C bus as there is not intedend connections for the BME280 to the i2c bus for RadSource products
...
class TeensyBME280_Temp : public Adafruit_Sensor
{
  public:
  TeensyBME280_Temp(TeensyBME280*parent) {_theBME280 = parent;}
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
  private:
  int _sensorID = 280;
  TeensyBME280*_theBME280 = NULL;
};

/////////////////////////NEW CLASS DEFINITION///////////////////////////////

class TeensyBME280_Pressure : public Adafruit_Sensor
{
  public:
      TeensyBME280_Pressure(TeensyBME280*parent) {_theBME280 = parent;}
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
  private:
  int _sensorID = 280;
...
class TeensyBME280_Humidity : public Adafruit_Sensor
{
  public:
  TeensyBME280_Humidity(TeensyBME280*parent) {_theBME280 = parent;}
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
  private:
  int _sensorID = 280;
...
public:
 ...
 //CONSTRUCTORS -- ONLY SPI CONSTRUCTORS AVALIABLE, NO I2C
 TeensyBME280(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);//need to specifiy ALL PINS FOR SPI CONNECTIONS
 //DESTRUCTOR
 ~TeensyBME280(void);
 bool init(); //makes connection to the device
 ...
 void setSampling(sensor_mode mode = MODE_NORMAL,
  ...
  void setTemperatureCompensation(float value);
  ...
  protected:
  SPIClass *_spi;
  TeensyBME280_Temp *temp_sensor = NULL;
  //!< Adafruit_Sensor compat temperature sensor component

  TeensyBME280_Pressure *pressure_sensor = NULL;
  //!< Adafruit_Sensor compat pressure sensor component

  TeensyBME280_Humidity *humidity_sensor = NULL;
